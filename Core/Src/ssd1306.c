...
static uint8_t ssd1306_WriteCommand_DMA(I2C_HandleTypeDef *hi2c, uint8_t command)
{
...
uint8_t ssd1306_UpdateScreen_DMA(I2C_HandleTypeDef *hi2c){
	...
	switch (updateScreenState) {
		case 0:
			ssd1306_WriteCommand_DMA(hi2c, 0xB0 + repetition);
			break;
		case 1:
			ssd1306_WriteCommand_DMA(hi2c, 0x00);
			break;
		case 2:
			ssd1306_WriteCommand_DMA(hi2c, 0x10);
			break;
		case 3:
			HAL_I2C_Mem_Write_DMA(hi2c, SSD1306_I2C_ADDR, 0x40, 1, &SSD1306_Buffer[SSD1306_WIDTH * repetition], SSD1306_WIDTH);
			break;
	}
