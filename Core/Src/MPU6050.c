...
uint8_t MPU6050_Init(I2C_HandleTypeDef *I2Cx)
{
    ...
    if (check == 104) // 0x68 will be returned by the sensor if everything goes well
    {
        ...
        Data = 0;
        if (HAL_I2C_Mem_Write(I2Cx, MPU6050_ADDR, PWR_MGMT_1_REG, 1, &Data, 1, i2c_timeout) != HAL_OK)
        	return 1;
        ...
        Data = 0x00;
        if (HAL_I2C_Mem_Write(I2Cx, MPU6050_ADDR, ACCEL_CONFIG_REG, 1, &Data, 1, i2c_timeout) != HAL_OK)
        	return 1;

        // Set Gyroscopic configuration in GYRO_CONFIG Register
        // XG_ST=0,YG_ST=0,ZG_ST=0, FS_SEL=0 -> � 250 �/s
        Data = 0x00;
        if (HAL_I2C_Mem_Write(I2Cx, MPU6050_ADDR, GYRO_CONFIG_REG, 1, &Data, 1, i2c_timeout) != HAL_OK)
        	return 1;
...
void MPU6050_Read_All(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct) {
	HAL_I2C_Mem_Read_DMA(I2Cx, MPU6050_ADDR, ACCEL_XOUT_H_REG, 1, (uint8_t*)DataStruct, 14);
}
